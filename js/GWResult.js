...
var servicesURL = "http://wim.usgs.gov/arcgis/rest/services/BadRiver/RESULTS/MapServer/"
    ...
    function executeSiteIdentifyTask(evt) {
        ...
        deferredResult.addCallback(function(response) {     
            ...
            return dojo.map(response, function(result) {
                ...
                if (result.layerId <= 6 ){
                	var template = new esri.InfoTemplate("Head Residuals",
						"<b>Name</b>: ${name}<br/>"+
                ...
                //Baseflow Residuals (group)
                	...
                	var template = new esri.InfoTemplate("Baseflow Residuals",
						"<b>Name</b>: ${name}<br/>"+
						"<b>Residual</b>: ${residual}<br/>" +
	                    "<b>Measured</b>: ${meas}<br/>" +
						"<b>Modeled</b>: ${modeled}<br/>" +
                ...
                //Groundwater Flow Velocity Vectors (group)
                	...
                	var template = new esri.InfoTemplate("Groundwater Velocity Vectors",
						"<b>Direction</b>: ${updown}<br/>"+
						"<b>Q</b>: ${Q}<br/>");
                ...
                //Stream-Aquifer Interactions
                	...
                	var template = new esri.InfoTemplate("Stream-Aquifer Interactions",
						"<b>Loss/Gain (cfd)</b>: ${loss}<br/>"+
						"<b>Overland (cfd)</b>: ${overland}<br/>"+
						"<b>Baseflow (cfd)</b>: ${flow}<br/>"+
						"<b>Stage (cfd)</b>: ${stage}<br/>");
                ...
                //Total Baseflow
                	...
                	var template = new esri.InfoTemplate("Total Baseflow",
						"<b>Loss/Gain (cfd)</b>: ${loss}<br/>"+
						"<b>Overland (cfd)</b>: ${overland}<br/>"+
						"<b>Baseflow (cfd)</b>: ${flow}<br/>"+
						"<b>Stage (cfd)</b>: ${stage}<br/>");
              	...
              	//Water Table Contour
                	...
                	var template = new esri.InfoTemplate("Water Table Elevation",
                ...
                //UZF Discharge  / Streamflow Routing Cells (group)
                	...
                	var pixelValue = result.feature.attributes['Pixel Value'];
                	var template = new esri.InfoTemplate("UZF Discharge",
